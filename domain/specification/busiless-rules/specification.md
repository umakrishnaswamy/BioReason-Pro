...
- local filesystem 上の生成物は作業用 scratch であり、正本は W&B Artifact / W&B Registry ref とする
...
spec 上の source-of-truth は W&B Artifact と W&B Registry ref とする。
...
- downstream の eval / SFT / RL は local dataset directory を正本にせず、W&B Registry ref から解決する
